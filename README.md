...
# Update SL Session 5 (Added New Features) : Anime Tier List & Review
This update is made to fulfill the task of Self Learning Session 5 Web Programming by Ko Anderies.

In this new feature, I added a page named "Anime Tier" to My Profile's Websites. The page contains a list of anime that I have recently watched along with the personal tier that I assigned to each of them. The tiers are categorized as follows:

-   **God Tier**
-   **Good Tier**
-   **Meh Tier**

![Anime Tier](https://github.com/brychan1298/my-profile-exercise/blob/master/public/readmeIMG/AnimeTierPage.png)

When you select one of the anime titles, you will be redirected to a page that shows the details of the anime that I reviewed. The details include a synopsis, review, and the reason why the anime is placed in the given tier.
